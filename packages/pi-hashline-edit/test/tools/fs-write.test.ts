...
describe("writeFileAtomically", () => {
	// POSIX file-mode assertions: Windows has no chmod/umask semantics (stat
	// reports 0o666 for everything), so skip the mode tests there.
	...
	it.skipIf(process.platform === "win32")("preserves the target file mode under a restrictive umask", async () => {
