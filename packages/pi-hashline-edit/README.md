...
> **Fork notice:** thin customized wrapper inspired by [**RimuruW's pi-hashline-edit**](https://github.com/RimuruW/pi-hashline-edit) (MIT), itself inspired by [oh-my-pi](https://github.com/can1357/oh-my-pi). Credit for the original design goes to RimuruW; this fork only adjusts dependencies and packaging. See [LICENSE](./LICENSE) for both copyright lines.
