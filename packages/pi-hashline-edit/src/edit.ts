...
const editToolDefinition: EditToolDefinition = {
	...
	prepareArguments: (args: unknown) => {
		...
		assertEditRequest(normalized);
		// Runtime-validated above; EditRequestParams.edits (HashlineToolEdit[]) is the
		// canonical shape the schema's Static describes — assert it for the definition.
		return normalized as Static<typeof hashlineEditToolSchema>;
	},
